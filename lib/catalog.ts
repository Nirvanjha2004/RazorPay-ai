...
/**
 * Build the agent-readable catalog (used by GET /api/catalog and the
 * GROWTH agent's get_catalog tool).
 */
export async function buildAgentCatalog(): Promise<AgentCatalog> {
